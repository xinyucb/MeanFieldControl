...
from DeepMKVSolver import deepPG, Network
...
def main():
    ...
    game_type = ["flocking", "aversion"][0] 
    Q_type = ["average", "twogroups"][1]   
    control_type = "full" 
    ...
    params = {
        ...
        "train": {
            ...
            "iteration": 5, "epochs": 50, "device": device,  # reduced iterations and epochs
        },
        "net": {

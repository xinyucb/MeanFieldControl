"""This script takes control input that depends on all particle Xt

A different setup is control input just depends on Xi
"""
...
class deepMKV(nn.Module):  # Solver for deep potential game
    ...
    def loss_function(
        ...
        for j in range(0, self.N):
            ...
            if self.control_type == "path_dependent":
                ...
                # Xt
                # Concatenate along time dimension, initial state, brownian increments

...
class PathMKV(nn.Module): 
    ...
    def loss_function(
        ...
        for j in range(0, self.N ):
            ...
            print(self.control_type, (self.control_type == "path_dependent" or "B"))
            ## Generate the control based on control type
            if self.control_type == "path_dependent" or "B":
            ...
            elif self.control_type == "markovian" or "X": #this should be changed
                ...
                net_input = net_input.view(self.M,-1)
                print("net_input", np.shape(net_input))
            # get current reward
